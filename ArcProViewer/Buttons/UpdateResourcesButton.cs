...
namespace ArcProViewer.Buttons
{
    internal class UpdateResourcesButton : Button
    {
        protected override void OnClick()
        {
            try
            {
                if (MessageBox.Show("Are you sure you want to update the Riverscapes Viewer resources?" +
                    "\n\nThis process can take several minutes and locks the ArcPro user interface while it is downloading new resources.", "Update Resources", MessageBoxButton.YesNo, MessageBoxImage.Question, MessageBoxResult.No)
